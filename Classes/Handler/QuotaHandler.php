...
class QuotaHandler
{
     ...
     * @var array<int,int>
     */
    private static array $storageUidByDeletedFileUid = [];
    ...
    {
        try {
            $folder = $file->getStorage()->getFolder(
    ...
    {
        QuotaUtility::updateStorageUsage(self::$storageUidByDeletedFileUid[$fileUid]);
    }
    ...
    {
        self::$storageUidByDeletedFileUid[(int)$file->getProperty('uid')] = (int)$file->getProperty('storage');
    }
